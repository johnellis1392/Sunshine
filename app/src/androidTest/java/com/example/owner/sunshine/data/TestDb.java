...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public long insertLocation() {
        ...
        long locationResId=db.insert(WeatherContract.LocationEntry.TABLE_NAME,
                null, contentValues);
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("testInsertReadDb weather entry failed to validate",
