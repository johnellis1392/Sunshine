...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        // The /* here matches all strings in the given path.
        // The /*/# matches all strings with a sub-path of an integer value.
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch(match) {
            case WEATHER: {
                rowsDeleted=sqLiteDatabase.delete(WeatherContract.WeatherEntry.TABLE_NAME,
                        selection, selectionArgs);
                break;
            }
            case LOCATION: {
                rowsDeleted=sqLiteDatabase.delete(WeatherContract.LocationEntry.TABLE_NAME,
                        selection, selectionArgs);
                break;
            }
            default: {
    ...
    public int update(
        ...
        switch(match) {
            case WEATHER: {
                normalizeDate(values);
                rowsUpdated=sqLiteDatabase.update(WeatherContract.WeatherEntry.TABLE_NAME,
                        values, selection, selectionArgs);
                break;
            }
            case LOCATION: {
                rowsUpdated=sqLiteDatabase.update(WeatherContract.LocationEntry.TABLE_NAME,
                        values, selection, selectionArgs);
                break;
            }
            default:
